...
class User extends Authenticatable implements CanSendOTPContract
{
    ...
    */
    ...
    protected function getMaskedMobileAttribute() {
        return env('APP_FOR') == 'demo' ? 9999999999 : $this->attributes['mobile'];
    }
    
    protected function getMaskedEmailAttribute() {
        return env('APP_FOR') == 'demo' ? 'test@test.com' : $this->attributes['email'];
    }
}
