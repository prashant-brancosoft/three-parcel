        ...
        const sos_update = async (sos) => {
            try {
                const response = await axios.get(
                    `rides-request/detail/${sos.req_id}`
                );
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                ...
                                <ul class="nested-list">
                                    ...
                                    <!-- <li class="list-group-item">
                                        <a href="/rental-package-types"
                                            ><i class="fas fa-box"></i>Rental
                                            Package</a
                                        >
                                    </li> -->
                                    <li class="list-group-item">
                            ...
                            <!-- <li class="list-group-item">
                                <a href="#"
                                    ><i class="fas fa-map"></i>Geofencing</a
                                >
                                <ul class="nested-list">
                                    <li class="list-group-item">
                                        <a href="/map/heat_map"
                                    ...
                                    <li class="list-group-item">
                                        <a href="/map/gods_eye"
                                            ><i class="fas fa-eye"></i>God's
                                            Eye</a
                                        >
                                    </li>
                                    <li class="list-group-item">
                                        <a href="/peak_zone"
                                            ><i class="fas fa-map-pin"></i>Peak
                                            Zone</a
                                        >
                                    </li>
                                </ul>
                            ...
                            <li class="list-group-item">
                                <a href="/delivery-rides-request"
                                    ><i class="fas fa-truck"></i>
                                    Orders
                                </a>
                            </li>
                            <!-- <li class="list-group-item">
                                <a href="/ongoing-rides"
                                    ><i class="fas fa-road"></i>Ongoing Rides</a
                                >
                            </li> -->
                            <li class="list-group-item">
                                <a href="#"
                                    ><i class="fas fa-ellipsis-h"></i>Others</a
                                >
                                <ul class="nested-list">
                                    <li class="list-group-item">
                                        <a href="/sos"
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <ul class="nested-list">
                                    ...
                                    <li class="list-group-item">
                                        <a href="/users/deleted-user"
                                            ><i class="fas fa-user-slash"></i
                                            >Delete Request Users</a
                                        >
                                    </li>
                                    <li class="list-group-item">
                                        <a href="/user-import"
                                            ><i class="fas fa-upload"></i>User
                                            Bulk Upload</a
                                        >
                                    </li>
                                </ul>
                            ...
                            <li class="list-group-item">
                                ...
                                <ul class="nested-list">
                                    <li class="list-group-item">
                                        <a href="/pending-drivers"
                                            ><i class="fas fa-user-clock"></i
                                            >Pending Drivers</a
                                        >
                                    </li>
                                    <li class="list-group-item">
                                        <a href="/approved-drivers"
                                    ...
                                    <li class="list-group-item">
                                        <a href="/drivers-rating"
                                            ><i class="fas fa-star"></i>Drivers
                                            Ratings</a
                                        >
                                    </li>
                                </ul>
                            ...
                            <li class="list-group-item">
                                <a href="/referral-settings"
                                    ><i class="fas fa-user-plus"></i>Referral
                                    Settings</a
                                >
                            </li>
                            <li class="list-group-item">
                            ...
                            <!-- <li class="list-group-item">
                                ...
                                <ul class="nested-list">
                                    <li class="list-group-item">
                                        <a href="/report/user-report"
                                            ><i class="fas fa-user"></i>User
                                            Report</a
                                        >
                                    </li>
                                    <li class="list-group-item">
                                        <a href="/report/driver-report"
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <a href="#"
                                    ><i class="fas fa-plug"></i>Third Party
                                    Settings</a
                                >
                                <ul class="nested-list">
                                    <!-- <li class="list-group-item">
                    ...
                    <BCardBody>
                        ...
                        >
                            ...
                            <div class="avatar-sm flex-shrink-0">
                                ...
                                >
                                    <i
                                        class="bx bx-user-circle text-success"
                                    ></i>
                                </span>
                            </div>
                        </div>
                    ...
                    <BCardBody>
                        ...
                        >
                            ...
                            <div class="avatar-sm flex-shrink-0">
                                ...
                                >
                                    <i
                                        class="bx bx-user-circle text-primary"
                                    ></i>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            >
                                ...
                                <tbody v-if="sosRequests.length > 0">
                                    <tr
                                        v-for="(result, index) in sosRequests"
                                        :key="index"
                                    >
                                        <td>{{ result.date }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                >
                                                    <Link
                                                        class="dropdown-item"
                                                        type="button"
                                                        :href="`rides-request/view/${result.request_id}`"
                                                    >
                                                        <i
                                                            class="bx bx-show-alt align-center text-muted me-2"
                                                        ></i>
                                                        {{ $t("view") }}
                                                    </Link>
                                                </div>
            ...
            <BCol xl="6" md="6">
                <BCard no-body class="card-height-100">
                    <BCardHeader class="align-items-center d-flex py-0">
                        <BCardTitle class="mb-0 flex-grow-1 p-3">{{
                            $t("today_trips")
                        }}</BCardTitle>
                    </BCardHeader>
                    <BCardBody>
                            ...
                            >
                                <tbody class="border-0">
                                    <tr>
                                        <td>
                                            <h4
                                                class="text-truncate fs-14 fs-medium mb-0"
                                            >
                                                <i
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <i
                                                    class="ri-stop-fill align-middle fs-18 text-info me-2"
                                                ></i
                                                >{{ $t("scheduled_rides") }}
                                            </h4>
                                        </td>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            ...
                                            >
                                                <i
                                                    class="bx bx-money text-info icon-lg"
                                                ></i>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                todayEarnings.wallet.toFixed(2)
                                            }}
                                        </h2>
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                todayEarnings.admin_commision.toFixed(
                                                    2
                                                )
                                            }}
                                        </h2>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                todayEarnings.driver_commision.toFixed(
                                                    2
                                                )
                                            }}
                                        </h2>
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-dark-subtle rounded-circle fs-2"
                                            >
                                                <i
                                                    class="bx bx-money text-dark icon-lg"
                                                ></i>
                                            </span>
                                        </div>
                                    </div>
                ...
                <BCard no-body class="card-height-100">
                    ...
                    <BCardBody>
                        <apexchart
                            ...
                            dir="ltr"
                            height="219"
                            :series="seriesOverallTrip"
                            :options="chartOptionsOverallTrip"
                        ></apexchart>
                        <div class="table-responsive mt-3">
                            <table
                                class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0"
                                ...
                                <tbody class="border-0">
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <i
                                                    class="ri-stop-fill align-middle fs-18 text-secondary me-2"
                                                ></i
                                                >{{ $t("completed_rides") }}
                                            </h4>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <i
                                                    class="ri-stop-fill align-middle fs-18 text-danger me-2"
                                                ></i
                                                >{{ $t("cancelled_rides") }}
                                            </h4>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <i
                                                    class="ri-stop-fill align-middle fs-18 text-success me-2"
                                                ></i
                                                >{{ $t("scheduled_rides") }}
                                            </h4>
                                        </td>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                overallEarnings.cash.toFixed(2)
                                            }}
                                        </h2>
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                overallEarnings.wallet.toFixed(
                                                    2
                                                )
                                            }}
                                        </h2>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                overallEarnings.card.toFixed(2)
                                            }}
                                        </h2>
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                overallEarnings.admin_commision.toFixed(
                                                    2
                                                )
                                            }}
                                        </h2>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                            {{
                                                overallEarnings.driver_commision.toFixed(
                                                    2
                                                )
                                            }}
                                        </h2>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            ...
                                            >
                                                <i
                                                    class="bx bx-user text-success icon-lg"
                                                ></i>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            ...
                                            >
                                                <i
                                                    class="bx bx-user text-warning icon-lg"
                                                ></i>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            ...
                                            >
                                                <i
                                                    class="bx bx-user text-info icon-lg"
                                                ></i>
                                            </span>
                                        </div>
                                    </div>
