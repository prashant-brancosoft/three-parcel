    ...
    methods: {
        ...
        invoiceToMail(invoiceType, id) {
            ...
            const response = axios.post(
                `/rides-request/send-invoice-mail/${id}`,
                {
    ...
    setup(props) {
        ...
        const fetchDatas = async (page = 1) => {
            try {
                ...
                params.page = page;
                const response = await axios.get(`/rides-request/list`, {
                    params,
                });
...
<template>
    <Layout>
        <Head title="Orders" />
        <PageHeader :title="$t('index')" :pageTitle="Orders" />
        <BRow>
            <BCol lg="12">
