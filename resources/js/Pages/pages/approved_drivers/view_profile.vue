...
export default {
    ...
    setup(props) {
        ...
        const initializeMap = async () => {
            ...
            const driversRef = firebase
                .database()
                .ref("drivers/driver_" + props.driver.id);
        ...
        const handleSubmit = async () => {
            ...
            try {
                ...
                let response = await axios.post(
                    `/approved-drivers/wallet-add-amount/${props.driver.id}`,
                    formData
                );
                ...
                if (response.status === 200) {
                    ...
                    router.get(
                        `/approved-drivers/view-profile/${props.driver.id}`
                    );
                } else {
        ...
        onMounted(async () => {
            ...
            if (
                !document.querySelector(
                    `script[src*="maps.googleapis.com/maps/api/js?key=${mapKey}"]`
                )
            ) {
        ...
        const fetchDatas1 = async (page = 1) => {
            try {
                ...
                const response = await axios.get(
                    `/approved-drivers/wallet-history/list/${props.driver.id}`,
                    { params }
                );
        ...
        const fetchRequestDatas = async (page = 1) => {
            ...
            params.page = page;
            const response = await axios.get(
                `/approved-drivers/request/list/${props.driver.id}`,
                { params }
            );
        ...
        const fetchWithdrawalDatas = async (page = 1) => {
            try {
                ...
                const response = await axios.get(
                    `/withdrawal-request-drivers/list`,
                    { params }
                );
                ...
                console.error(
                    t("error_fetching_withdrawal_request_drivers"),
                    error
                );
            }
        };
        ...
        const fetchRatingDatas = async (page = 1) => {
            try {
                ...
                const response = await axios.get(
                    `/drivers-rating/request-list/${props.driver.id}`,
                    { params }
                );
        ...
        const fetchDocumentDatas = async (page = 1) => {
            try {
                const params = { page: page };
                const response = await axios.get(
                    `/approved-drivers/document/list/${props.driver.id}`,
                    { params }
                );
        ...
        const approveDocument = async (documentId) => {
            ...
            const response = await axios.post(
                `/approved-drivers/document-toggle/${documentId}/${props.driver.id}/${status}`
            );
        ...
        const viewDocument = (document) => {
            ...
            documentNameFront.value =
                document.document_name_front ?? t("document");
            documentNameBack.value =
                document.document_name_back ?? t("document");
        };
        ...
        const handleReasonSubmit = async () => {
            try {
                const status = 5;
                const response = await axios.post(
                    `/approved-drivers/document-toggle/${document_id.value}/${props.driverId}/${status}`,
                    {
                        reason: form.reason,
                    }
                );
...
<template>
    <Layout>
        ...
        <PageHeader
            :title="$t('driver_profile')"
            :pageTitle="$t('driver_profile')"
            pageLink="/approved-drivers"
        />
        <BRow>
            <!-- Main Content Area -->

            <!-- Right Sidebar for Profile Info and Tabs -->
            <BCol lg="3">
                <BCard no-body class="h-100">
                    <BCardHeader class="border-0">
                        ...
                        <div class="profile-info">
                            <div class="row">
                                <div class="col-sm-12 mt-3 profile-border">
                                ...
                                <div class="col-sm-12 mt-4 profile-border">
                                    <div class="d-flex align-items-center">
                                        <i
                                            class="ri-phone-line"
                                ...
                                <div
                                    ...
                                    v-if="driver.vehicle_type_image"
                                >
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <img
                    ...
                    <div class="tab-content text-muted">
                            ...
                            <BCard>
                                <BCardBody>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div
                                                class="row row-cols-lg-4 row-cols-1"
                                            >
                                                <div class="col">
                                                    <div
                                                        class="card card-body border card-hover"
                                                    >
                                                        <div
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="bx bx-car text-success icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="bx bx-money text-success icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    <span
                                                                        class="avatar-title bg-primary-subtle rounded-circle fs-2"
                                                                    >
                                                                        <i
                                                                            class="bx bx-car text-primary icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="bx bx-money text-primary icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="bx bx-car text-danger icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="row">
                                        <div
                                            class="col-sm-6 col-md-12 col-lg-12 col-xl-6"
                                        >
                                            <apexchart
                                                class="apex-charts"
                                                height="350"
                                                    ...
                                                    >
                                                        ...
                                                        <div class="d-flex">
                                                            <h3 class="mb-1">
                                                                ...
                                                                {{
                                                                    earnings_data.admin_commission
                                                                }}
                                                            </h3>
                                                        </div>
                                                        <h5
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    <span
                                                                        class="avatar-title bg-warning-subtle rounded-circle fs-2"
                                                                    >
                                                                        <i
                                                                            class="bx bx-money text-warning icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="d-flex">
                                                            <h3 class="mb-1">
                                                                ...
                                                                {{
                                                                    earnings_data.driver_commission
                                                                }}
                                                            </h3>
                                                        </div>
                                                        <h5
                                                        ...
                                                        >
                                                            <div>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <i
                                                                            class="bx bx-credit-card text-warning icon-lg"
                                                                        ></i>
                                                                    </span>
                                                                </div>
                                                                <div
                                                                    class="border p-1 rounded ms-3"
                                                                >
                                                                    {{
                                                                        earnings_data.overall_card
                                                                    }}
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div
                                            class="col-sm-6 col-md-12 col-xl-6 col-lg-6"
                                        >
                                            <apexchart
                                                class="apex-charts"
                                                height="350"
                                ...
                                <BCardBody>
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="bx bx-check-circle text-success icon-lg"
                                                                ></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="bx bx-x-circle text-danger icon-lg"
                                                                ></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <BRow class="g-2">
                                        <BCol md="3" class="mb-3">
                                            ...
                                            >
                                                ...
                                                >
                                                    <option
                                                        v-for="option in paginatorOption"
                                                        :key="option"
                                                        :value="option"
                                                    >
                                                        {{ option }}
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        >
                                            ...
                                            <tbody v-else>
                                                <tr>
                                                    ...
                                                    >
                                                        <img
                                                            src="@assets/images/search-file.gif"
                                                            alt="Loading..."
                                                            style="width: 100px"
                                                        />
                                                        <h5>
                                        ...
                                        <Pagination
                                            ...
                                            @page-changed="handlePageChanged2"
                                        />
                                    </div>
                                </BCardBody>
                            </BCard>
                            <BOffcanvas
                                v-model="rightOffcanvas"
                                placement="end"
                                :title="$t('filters')"
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <i
                                                                    class="bx bx-money text-danger icon-lg"
                                                                ></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <BCardBody>
                                    ...
                                    <div class="table-responsive mt-5">
                                        ...
                                        <Pagination
                                            ...
                                            @page-changed="handlePageChanged1"
                                        />
                                    </div>
                                </BCardBody>
                            </BCard>
                                ...
                                <BCardBody>
                                    <BCol md="3" class="mb-3">
                                        ...
                                        >
                                            ...
                                            >
                                                <option
                                                    v-for="option in withdrawalpaginatorOption"
                                                    :key="option"
                                                    :value="option"
                                                >
                                                    {{ option }}
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            >
                                                                <Link
                                                                    class="dropdown-item"
                                                                    :href="`/withdrawal-request-drivers/view-in-detail/${result.driver_id}`"
                                                                    ><i
                                                                        class="bx bx-radio-circle-marked align-center text-muted me-2"
                                                                    ></i>
                                                                    {{
                                                                        $t(
                                                                            "view_in_details"
                        ...
                        >
                            <BCard>
                                <BCardBody>
                                    <div
                                        class="timeline-continue p-2"
                                        v-for="result in ratingResults"
                                        :key="result.id"
                                    >
                                                            ...
                                                            >
                                                                ...
                                                                <div>
                                                                    <i
                                                                        ...
                                                                        class="align-center text-muted me-2"
                                                                    ></i>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <Pagination
                                        ...
                                        @page-changed="handleRatingPageChanged"
                                    />
                                </BCardBody>
                            </BCard>
                        </div>
                        ...
                        >
                                            ...
                                            <tbody>
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        ...
                                                        >
                                                            <i
                                                                class="bx bx-show-alt align-center"
                                                            ></i>
                                                        </BButton>
                                                        <BButton
                                                            ...
                                                            v-b-tooltip.hover
                                                            title="upload"
                                                            :href="`/approved-drivers/document-upload/${document.id}/${driver.id}`"
                                                        >
                                                            <i
                                                                class="bx bx-upload align-center"
                                                            ></i>
                                                        </BButton>
                                                    </td>
                                                    <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div
                                                        ...
                                                        class="carousel slide carousel-fade py-5"
                                                        data-ride="carousel"
                                                    >
                                                        <div
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <i
                                                                        class="ri-image-fill m-auto fs-22"
                                                                    ></i>
                                                                    <h6
                            ...
                            <BModal
                                v-model="disapproveModelShow"
                                hide-footer
                                :title="$t('declined_reason')"
                                    ...
                                    >
                                        ...
                                        >
                                            <BLink
                                                ...
                                                class="btn btn-link link-warning fw-medium"
                                                @click="
                                                    disapproveModelShow = false
                                                "
                                            >
                                                <i
