...
export default {
    ...
    setup(props) {
        ...
        watch(selectedLocation, (value) => {
            ...
            zoneList.value = zones.value.filter(
                (zone) => zone.service_location_id == filter.service_location_id
            );
            fetchDatas();
        });
        ...
        onMounted(async () => {
            try {
                ...
                zoneList.value = zones.value.filter(
                    (zone) =>
                        zone.service_location_id == filter.service_location_id
                );
                fetchDatas();
            } catch (error) {
                console.error(
                    t("error_initializing_firebase_or_fetching_settings"),
                    error
                );
            }
        });
        ...
        const viewProfile = async (result) => {
            console.log("driver detils=> ", result);
            router.get(`/users/view-profile/${result.driver_detail.name}`);
        };
        return {
            results,
            modalShow,
...
<template>
    <Layout>
        <Head title="Orders" />
        <PageHeader :title="$t('orders')" :pageTitle="$t('orders')" />
        <BRow>
            <BCol lg="12">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            >
                                                ...
                                                >
                                                    <a
                                                        class="nav-link fw-semibold btn"
                                                        :class="{
                                                            active:
                                                                activeTab ===
                                                                'all',
                                    ...
                                    >
                                        ...
                                        <td>
                                            <a
                                                ...
                                                :href="
                                                    result.user_detail &&
                                                    result.user_detail.id
                                                        ? `/users/view-profile/${result.user_detail.id}`
                                                        : '#'
                                                "
                                            >
                                                {{
                                        ...
                                        <td>
                                            <a
                                                ...
                                                :href="
                                                    ...
                                                    result.driver_detail.id
                                                        ? `/users/view-profile/${result.driver_detail.id}`
                                                        : '#'
                                                "
                                            >
                                                {{
                                            ...
                                            <div class="dropdown">
                                                ...
                                                >
                                                    ...
                                                    <Link
                                                        ...
                                                        "
                                                        type="button"
                                                        :href="`ongoing-rides/assign/${result.id}`"
                                                    >
                                                        <i
                                                            class="bx bx-show-alt align-center text-muted me-2"
                                                        ></i>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <i
                                                                class="bx bx-file align-center text-muted me-2"
                                                            ></i>
                                                            {{
                                                                $t(
