    ...
    setup(props) {
        ...
        const handleSubmit = async () => {
            ...
            try {
                ...
                let response = await axios.post(
                    `/users/wallet-add-amount/${props.user.id}`,
                    formData
                );
        ...
        const fetchDatas = async (page = 1) => {
            try {
                ...
                const response = await axios.get(
                    `/users/wallet-history/list/${props.user.id}`,
                    { params }
                );
        ...
        const fetchRequestDatas = async (page = 1) => {
            try {
                ...
                params.page = page;
                const response = await axios.get(
                    `/users/request/list/${props.user.id}`,
                    { params }
                );
        ...
        const fetchRatingDatas = async (page = 1) => {
            try {
                ...
                const response = await axios.get(
                    `/users/rating-list/${props.user.id}`,
                    { params }
                );
...
<template>
    <Layout>
        ...
        />
        <BRow>
            <!-- Left Sidebar for Profile Info and Tabs -->
            <BCol lg="3">
                                        ...
                                        >
                                            ...
                                            <tbody v-if="requests.length > 0">
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        {{
                                                            request.converted_trip_start_time_date
                                                        }}
                                                    </td>
                                                    <td>
                                                        {{ request.user_name }}
        ...
        >
            ...
            >
                <div class="offcanvas-body">
                    <div class="mb-4">
                        ...
                        >
                            ...
                            <option value="ontrip">On Progress</option>
                        </select>
                    </div>
                    <div class="mb-4">
                        <label
                ...
                >
                    <BButton variant="light" @click="clearFilter" class="w-100">
