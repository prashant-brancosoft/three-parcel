        ...
        const toggleActiveStatus = async (id, status) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        await axios.post(`/users/update-status`, {
                            id: id,
                            status: status,
                        });
                                            ...
                                            >
                                                <div class="dropdown">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <i
                                                                class="bx bxs-edit-alt align-center text-muted me-2"
                                                            ></i
                                                            >{{ $t("edit") }}
                                                        </a>
                                                        <a
                                                        ...
                                                        >
                                                            <i
                                                                class="bx bxs-trash-alt align-center text-muted me-2"
                                                            ></i
                                                            >{{ $t("delete") }}
                                                        </a>
                                                    </div>
                ...
                <div class="card card-height-100">
                    <div class="card-body">
                        <div class="d-flex flex-column h-100">
                            ...
                            <div
                                class="d-flex mb-2 card-footer bg-transparent border-top-dashed"
                            >
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar-sm">
                                        ...
                                        >
                                            ...
                                            <img
                                                class="avatar-xs rounded-circle p-1"
                                                alt="profile picture"
                                    ...
                                    <p class="mb-0">
                                        <i
                                            ...
                                            :class="{
                                                ...
                                                'bx bxs-star-half text-warning':
                                                    n ===
                                                        Math.ceil(
                                                            result.rating
                                                        ) &&
                                                    result.rating % 1 !== 0,
                                                'bx bx-star text-muted':
                                                    n > result.rating,
                                            }"
                                            class="align-center me-2"
                                        ></i>
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="fw-medium" scope="row">
                                                <i
                                                    class="las la-transgender fs-24"
                                                ></i>
                                            </td>
                                            <td>
                                                {{ result.gender ?? "----" }}
                                        ...
                                        <tr>
                                            <td class="fw-medium" scope="row">
                                                <i
                                                    class="las la-phone fs-24"
                                                ></i>
                                            </td>
                                            <td>
                                                {{
                                                    mobileFromUser(result) ??
                                                    "----"
                                                }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fw-medium" scope="row">
                                                <i
                                                    class="las la-envelope-open-text fs-24"
                                                ></i>
                                            </td>
                                            <td>
                                                {{
                                                    emailFromUser(result) ??
                                                    "----"
                                                }}
                                            </td>
                                        </tr>
